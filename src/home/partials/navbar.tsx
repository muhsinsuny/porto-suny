...
const Navbar = () => {
  return (
    <header className='flex-between custom-container top-0 z-100 h-20 w-full items-center justify-center py-6.25 text-white md:absolute md:z-100 md:items-center md:px-32'>
