...
export const AboutMe: React.FC<AboutmeProps> = () => {
  return (
    <>
      <div className='custom-container md:flex-center relative mb-0 flex h-[693px] w-full flex-col items-center bg-red-500 pt-10 md:relative md:mt-30 md:mb-0 md:flex md:h-[631px] md:flex-col md:px-28 md:pt-30'>
