  ...
  return (
    ...
    >
      ...
      <div className='md:flex md:flex-row md:items-center'>
        ...
        >
          <div className='z-10 flex flex-col items-center justify-center md:h-[450]'>
            <Image
            ...
            {/* Social Media */}
            <div className='flex-center absolute top-75 z-50 flex flex-row gap-4 md:top-[300] md:block'>
            ...
            <h3 className='text-md-bold absolute top-91 z-50 text-neutral-200 md:top-[360]'>
              Muhsin Suny M.
            </h3>
            <div className='flex-center absolute top-97 z-50 flex flex-row gap-3 md:top-[385]'>
